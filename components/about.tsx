  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        . I am also familiar with TypeScript and Prisma and in payment i prefer
        stripe. I am always looking to learn new technologies. I am currently
      ...
      <p>
        ...
        video piano, watching documentation, and playing with my dog. I also
        enjoy <span className="font-medium">learning new things</span>. I am
        currently learning about{" "}
        <span className="font-medium">RObotcs and AI</span>. I'm also learning
